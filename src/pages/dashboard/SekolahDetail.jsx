  ...
  if (!sekolah) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 mb-4">Sekolah dengan ID tersebut tidak ditemukan dalam database</p>
        <Link
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <nav className="flex mb-4" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            <li className="inline-flex items-center">
              <Link to="/dashboard" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#4675C0]">
            ...
            <li>
              <div className="flex items-center">
                ...
                <Link to="/dashboard/sekolah" className="ml-1 text-sm font-medium text-gray-700 hover:text-[#4675C0] md:ml-2">
                  Data Sekolah
                </Link>
              </div>
            </li>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              to={`/dashboard/sekolah/edit/${id}`}
              className="px-4 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-gray-900">{sekolah.email || '-'}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Sidebar - Informasi Teknis dan Aksi */}
        <div className="space-y-6">
          {/* Status dan Info Card */}
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Status Data</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-gray-900 text-sm">{formatDate(sekolah.updated_at)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Tanggal Input</span>
                <span className="text-gray-900 text-sm">{formatDate(sekolah.created_at)}</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900">{sekolah.email || 'Tidak tersedia'}</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">{formatDate(sekolah.created_at)}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">
                  {user?.role === 'admin' ? 'Publik' : 'Terbatas'}
                </span>
              </div>
            </div>
          </div>
